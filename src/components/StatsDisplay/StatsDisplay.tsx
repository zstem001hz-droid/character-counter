...
export const StatsDisplay: React.FC<StatsDisplayProps> = ({
    ...
    return (
        <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
            ...
            <div style={{ textAlign: 'center', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', flex: 1 }}>
                <p style={{ fontSize: '12px', color: '666' }}>Characters</p>
                <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{stats.characterCount}</p>
            </div>

            {/* Word count statistics */}
            <div style={{ textAlign: 'center', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', flex: 1 }}>
                <p style={{ fontSize: '12px', color: '#666' }}>Words</p>
                <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{stats.wordCount}</p>
            </div>
            ...
            {showReadingTime && (
                <div style={{ textAlign: 'center', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', flex: 1 }}>
                    ...
                    <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{formatReadingTime(stats.readingTime)}</p>
                    </div>
            )}
